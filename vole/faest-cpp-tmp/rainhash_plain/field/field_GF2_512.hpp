...
void clmul_schoolbook_256bits(__m128i out[4], const __m128i a[2],
                             const __m128i b[2]) {
  __m128i tmp[4];
...
void clmul_schoolbook(__m128i out[8], const __m128i a[4], const __m128i b[4]) {
...
void reduce_clmul(__m128i out[4], __m128i in[8]) {
...
GF2_512::GF2_512(std::string hex_string) {
...
GF2_512 GF2_512::operator+(const GF2_512 &other) const {
  GF2_512 result;
  gf512add(result.as_m128i(), this->as_const_m128i(), other.as_const_m128i());
  return result;
}
GF2_512 &GF2_512::operator+=(const GF2_512 &other) {
...
bool GF2_512::operator==(const GF2_512 &other) const {
...
void GF2_512::to_bytes(uint8_t *out) const {
...
void GF2_512::from_bytes(const uint8_t *in) {
...
// field::GF2_512 dot_product(const std::vector<field::GF2_512> &lhs,
//                            const std::vector<field::GF2_512> &rhs) {
...
//   // combined reduction
//   field::GF2_512 result;
//   reduce_clmul(result.as_m128i(), accum);
//   return result;
// }

// std::ostream &operator<<(std::ostream &os, const field::GF2_512 &ele) {
...
// TEMPLATE INSTANTIATIONS for GF2_512

// yes we include the cpp file with the template stuff
// #include "field_templates.h"

// INSTANTIATE_TEMPLATES_FOR(field::GF2_512)
// END TEMPLATE INSTANTIATIONS for GF2_512
