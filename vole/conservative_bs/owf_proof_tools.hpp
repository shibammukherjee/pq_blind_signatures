...
//  linearity of the (Frobenius) map in characteristic 2
...
// Look into the misc/lin_frobenius_f2_sq_map.sage script!
template <typename QS, size_t deg>
inline void square_4_bits(quicksilver_gf2<QS, deg>* y, const quicksilver_gf2<QS, deg>* x)
{
    // 4x4 linear transformation matrix for x ↦ x^2 over GF(2^4):
    // [1 0 1 0]
    // [0 0 1 0]
    // [0 1 0 1]
    // [0 0 0 1]
