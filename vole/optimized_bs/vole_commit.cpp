...
template void vole_commit<v1::mayo_128_s>(block_secpar<v1::mayo_128_s::secpar_v>, block128, block_secpar<v1::mayo_128_s::secpar_v>* __restrict__, unsigned char* __restrict__, vole_block* __restrict__, vole_block* __restrict__, uint8_t* __restrict__, uint8_t* __restrict__);
template void vole_commit<v1::mayo_128_f>(block_secpar<v1::mayo_128_f::secpar_v>, block128, block_secpar<v1::mayo_128_f::secpar_v>* __restrict__, unsigned char* __restrict__, vole_block* __restrict__, vole_block* __restrict__, uint8_t* __restrict__, uint8_t* __restrict__);
template void vole_commit<v1::mayo_192_s>(block_secpar<v1::mayo_192_s::secpar_v>, block128, block_secpar<v1::mayo_192_s::secpar_v>* __restrict__, unsigned char* __restrict__, vole_block* __restrict__, vole_block* __restrict__, uint8_t* __restrict__, uint8_t* __restrict__);
template void vole_commit<v1::mayo_192_f>(block_secpar<v1::mayo_192_f::secpar_v>, block128, block_secpar<v1::mayo_192_f::secpar_v>* __restrict__, unsigned char* __restrict__, vole_block* __restrict__, vole_block* __restrict__, uint8_t* __restrict__, uint8_t* __restrict__);
template void vole_commit<v1::mayo_256_s>(block_secpar<v1::mayo_256_s::secpar_v>, block128, block_secpar<v1::mayo_256_s::secpar_v>* __restrict__, unsigned char* __restrict__, vole_block* __restrict__, vole_block* __restrict__, uint8_t* __restrict__, uint8_t* __restrict__);
template void vole_commit<v1::mayo_256_f>(block_secpar<v1::mayo_256_f::secpar_v>, block128, block_secpar<v1::mayo_256_f::secpar_v>* __restrict__, unsigned char* __restrict__, vole_block* __restrict__, vole_block* __restrict__, uint8_t* __restrict__, uint8_t* __restrict__);
...
template void vole_commit<v2::mayo_128_s>(block_secpar<v2::mayo_128_s::secpar_v>, block128, block_secpar<v2::mayo_128_s::secpar_v>* __restrict__, unsigned char* __restrict__, vole_block* __restrict__, vole_block* __restrict__, uint8_t* __restrict__, uint8_t* __restrict__);
template void vole_commit<v2::mayo_128_f>(block_secpar<v2::mayo_128_f::secpar_v>, block128, block_secpar<v2::mayo_128_f::secpar_v>* __restrict__, unsigned char* __restrict__, vole_block* __restrict__, vole_block* __restrict__, uint8_t* __restrict__, uint8_t* __restrict__);
template void vole_commit<v2::mayo_192_s>(block_secpar<v2::mayo_192_s::secpar_v>, block128, block_secpar<v2::mayo_192_s::secpar_v>* __restrict__, unsigned char* __restrict__, vole_block* __restrict__, vole_block* __restrict__, uint8_t* __restrict__, uint8_t* __restrict__);
template void vole_commit<v2::mayo_192_f>(block_secpar<v2::mayo_192_f::secpar_v>, block128, block_secpar<v2::mayo_192_f::secpar_v>* __restrict__, unsigned char* __restrict__, vole_block* __restrict__, vole_block* __restrict__, uint8_t* __restrict__, uint8_t* __restrict__);
template void vole_commit<v2::mayo_256_s>(block_secpar<v2::mayo_256_s::secpar_v>, block128, block_secpar<v2::mayo_256_s::secpar_v>* __restrict__, unsigned char* __restrict__, vole_block* __restrict__, vole_block* __restrict__, uint8_t* __restrict__, uint8_t* __restrict__);
template void vole_commit<v2::mayo_256_f>(block_secpar<v2::mayo_256_f::secpar_v>, block128, block_secpar<v2::mayo_256_f::secpar_v>* __restrict__, unsigned char* __restrict__, vole_block* __restrict__, vole_block* __restrict__, uint8_t* __restrict__, uint8_t* __restrict__);
...
template bool vole_reconstruct<v1::mayo_128_s>(block128, vole_block* __restrict__, const uint8_t*, const uint8_t* __restrict__, const uint8_t* __restrict__, uint8_t* __restrict__);
template bool vole_reconstruct<v1::mayo_128_f>(block128, vole_block* __restrict__, const uint8_t*, const uint8_t* __restrict__, const uint8_t* __restrict__, uint8_t* __restrict__);
template bool vole_reconstruct<v1::mayo_192_s>(block128, vole_block* __restrict__, const uint8_t*, const uint8_t* __restrict__, const uint8_t* __restrict__, uint8_t* __restrict__);
template bool vole_reconstruct<v1::mayo_192_f>(block128, vole_block* __restrict__, const uint8_t*, const uint8_t* __restrict__, const uint8_t* __restrict__, uint8_t* __restrict__);
template bool vole_reconstruct<v1::mayo_256_s>(block128, vole_block* __restrict__, const uint8_t*, const uint8_t* __restrict__, const uint8_t* __restrict__, uint8_t* __restrict__);
template bool vole_reconstruct<v1::mayo_256_f>(block128, vole_block* __restrict__, const uint8_t*, const uint8_t* __restrict__, const uint8_t* __restrict__, uint8_t* __restrict__);
...
template bool vole_reconstruct<v2::mayo_128_s>(block128, vole_block* __restrict__, const uint8_t*, const uint8_t* __restrict__, const uint8_t* __restrict__, uint8_t* __restrict__);
template bool vole_reconstruct<v2::mayo_128_f>(block128, vole_block* __restrict__, const uint8_t*, const uint8_t* __restrict__, const uint8_t* __restrict__, uint8_t* __restrict__);
template bool vole_reconstruct<v2::mayo_192_s>(block128, vole_block* __restrict__, const uint8_t*, const uint8_t* __restrict__, const uint8_t* __restrict__, uint8_t* __restrict__);
template bool vole_reconstruct<v2::mayo_192_f>(block128, vole_block* __restrict__, const uint8_t*, const uint8_t* __restrict__, const uint8_t* __restrict__, uint8_t* __restrict__);
template bool vole_reconstruct<v2::mayo_256_s>(block128, vole_block* __restrict__, const uint8_t*, const uint8_t* __restrict__, const uint8_t* __restrict__, uint8_t* __restrict__);
template bool vole_reconstruct<v2::mayo_256_f>(block128, vole_block* __restrict__, const uint8_t*, const uint8_t* __restrict__, const uint8_t* __restrict__, uint8_t* __restrict__);
