use crate::{
    blind_sig_conservative_deg16::BlindSignatureConservativeDeg16,
    zk::{ZKType, vole_keccak_deg16_then_mayo::VOLEKeccakDeg16ThenMAYO},
};
...
impl BlindSignatureConservativeDeg16 {
    ...
    pub fn setup(security_level: ZKType) -> Self {
        ...
        Self {
            ...
            vole_keccak_then_mayo: VOLEKeccakDeg16ThenMAYO::setup(security_level),
        }
    }
}
