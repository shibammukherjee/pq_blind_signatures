...
use vole_keccak_then_mayo_sys::get_keccak_then_mayo128fv1_parameters;
use vole_keccak_then_mayo_sys::get_keccak_then_mayo128fv2_parameters;
use vole_keccak_then_mayo_sys::get_keccak_then_mayo128sv1_parameters;
use vole_keccak_then_mayo_sys::get_keccak_then_mayo128sv2_parameters;
use vole_keccak_then_mayo_sys::get_keccak_then_mayo192fv1_parameters;
use vole_keccak_then_mayo_sys::get_keccak_then_mayo192fv2_parameters;
use vole_keccak_then_mayo_sys::get_keccak_then_mayo192sv1_parameters;
use vole_keccak_then_mayo_sys::get_keccak_then_mayo192sv2_parameters;
use vole_keccak_then_mayo_sys::get_keccak_then_mayo256fv1_parameters;
use vole_keccak_then_mayo_sys::get_keccak_then_mayo256fv2_parameters;
use vole_keccak_then_mayo_sys::get_keccak_then_mayo256sv1_parameters;
use vole_keccak_then_mayo_sys::get_keccak_then_mayo256sv2_parameters;

use vole_keccak_then_mayo_sys::keccak_then_mayo128fv1_prove;
use vole_keccak_then_mayo_sys::keccak_then_mayo128fv2_prove;
use vole_keccak_then_mayo_sys::keccak_then_mayo128sv1_prove;
use vole_keccak_then_mayo_sys::keccak_then_mayo128sv2_prove;
use vole_keccak_then_mayo_sys::keccak_then_mayo192fv1_prove;
use vole_keccak_then_mayo_sys::keccak_then_mayo192fv2_prove;
use vole_keccak_then_mayo_sys::keccak_then_mayo192sv1_prove;
use vole_keccak_then_mayo_sys::keccak_then_mayo192sv2_prove;
use vole_keccak_then_mayo_sys::keccak_then_mayo256fv1_prove;
use vole_keccak_then_mayo_sys::keccak_then_mayo256fv2_prove;
use vole_keccak_then_mayo_sys::keccak_then_mayo256sv1_prove;
use vole_keccak_then_mayo_sys::keccak_then_mayo256sv2_prove;

use vole_keccak_then_mayo_sys::keccak_then_mayo128fv1_verify;
use vole_keccak_then_mayo_sys::keccak_then_mayo128fv2_verify;
use vole_keccak_then_mayo_sys::keccak_then_mayo128sv1_verify;
use vole_keccak_then_mayo_sys::keccak_then_mayo128sv2_verify;
use vole_keccak_then_mayo_sys::keccak_then_mayo192fv1_verify;
use vole_keccak_then_mayo_sys::keccak_then_mayo192fv2_verify;
use vole_keccak_then_mayo_sys::keccak_then_mayo192sv1_verify;
use vole_keccak_then_mayo_sys::keccak_then_mayo192sv2_verify;
use vole_keccak_then_mayo_sys::keccak_then_mayo256fv1_verify;
use vole_keccak_then_mayo_sys::keccak_then_mayo256fv2_verify;
use vole_keccak_then_mayo_sys::keccak_then_mayo256sv1_verify;
use vole_keccak_then_mayo_sys::keccak_then_mayo256sv2_verify;

pub struct VOLEKeccakThenMAYOParameters {
...
impl VOLEKeccakThenMAYOParameters {
    pub fn setup(params: ZKType) -> Self {
        ...
        let get_params_fun: GetParamsFn =
            VOLEKeccakThenMAYOParameters::get_get_params_function(params);
        ...
        Self {
            ...
            h_size,
            s_size,
            prove_fn: VOLEKeccakThenMAYOParameters::get_prove_function(params),
            verify_fn: VOLEKeccakThenMAYOParameters::get_verify_function(params),
        }
    }
